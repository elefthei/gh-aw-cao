...
const TRANSACTION_EVENT_FIELDS = {
  ...
  verificationComparisonId: "verification-comparison-id",
  ...
  verifierRunAttempt: "verifier-run-attempt",
  verifierWorkflowPath: "verifier-workflow-path",
  verifierWorkflowName: "verifier-workflow-name",
  baselineWindow: "baseline-window",
  optimizedWindow: "optimized-window",
  sourceGenerations: "source-generations",
  baselineAicPerAcceptedOutcome: "baseline-aic-per-accepted-outcome",
  optimizedAicPerAcceptedOutcome: "optimized-aic-per-accepted-outcome",
  baselineAcceptedTargetOutcomeCount: "baseline-accepted-target-outcome-count",
  optimizedAcceptedTargetOutcomeCount: "optimized-accepted-target-outcome-count",
  acceptedTargetOutcomeCount: "accepted-target-outcome-count",
  baselineFailureRate: "baseline-failure-rate",
  optimizedFailureRate: "optimized-failure-rate",
  outcomeQualityPreserved: "outcome-quality-preserved",
  reliabilityPreserved: "reliability-preserved",
  grossRealizedSavingsAic: "gross-realized-savings-aic",
  optimizationOverheadAic: "optimization-overhead-aic",
  netRealizedSavingsAic: "net-realized-savings-aic",
  verifiedNetGain: "verified-net-gain",
  attributableOverheadRunIds: "attributable-overhead-run-ids",
  baselineInputTokens: "baseline-input-tokens",
  optimizedInputTokens: "optimized-input-tokens",
  baselineOutputTokens: "baseline-output-tokens",
  optimizedOutputTokens: "optimized-output-tokens",
  baselineCacheReadTokens: "baseline-cache-read-tokens",
  optimizedCacheReadTokens: "optimized-cache-read-tokens",
  baselineCacheWriteTokens: "baseline-cache-write-tokens",
  optimizedCacheWriteTokens: "optimized-cache-write-tokens",
  baselineReasoningTokens: "baseline-reasoning-tokens",
  optimizedReasoningTokens: "optimized-reasoning-tokens",
  maturityAt: "maturity-at",
