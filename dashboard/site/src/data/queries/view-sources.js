    ...
    rows: ordered.map((event) => {
      ...
      return {
        ...
        ...definedFields({
          ...
          'comparison-id': event.comparisonId,
          'verification-comparison-id': event.verificationComparisonId,
          ...
          'evaluator-digest': event.evaluatorDigest,
          'verifier-run-attempt': event.verifierRunAttempt,
          'verifier-workflow-path': event.verifierWorkflowPath,
          'verifier-workflow-name': event.verifierWorkflowName,
          'baseline-window': event.baselineWindow,
          'optimized-window': event.optimizedWindow,
          'source-generations': event.sourceGenerations,
          'baseline-aic-per-accepted-outcome': event.baselineAicPerAcceptedOutcome,
          'optimized-aic-per-accepted-outcome': event.optimizedAicPerAcceptedOutcome,
          'baseline-accepted-target-outcome-count': event.baselineAcceptedTargetOutcomeCount,
          'optimized-accepted-target-outcome-count': event.optimizedAcceptedTargetOutcomeCount,
          'accepted-target-outcome-count': event.acceptedTargetOutcomeCount,
          'baseline-failure-rate': event.baselineFailureRate,
          'optimized-failure-rate': event.optimizedFailureRate,
          'outcome-quality-preserved': event.outcomeQualityPreserved,
          'reliability-preserved': event.reliabilityPreserved,
          'gross-realized-savings-aic': event.grossRealizedSavingsAic,
          'optimization-overhead-aic': event.optimizationOverheadAic,
          'net-realized-savings-aic': event.netRealizedSavingsAic,
          'verified-net-gain': event.verifiedNetGain,
          'attributable-overhead-run-ids': event.attributableOverheadRunIds,
          'baseline-input-tokens': event.baselineInputTokens,
          'optimized-input-tokens': event.optimizedInputTokens,
          'baseline-output-tokens': event.baselineOutputTokens,
          'optimized-output-tokens': event.optimizedOutputTokens,
          'baseline-cache-read-tokens': event.baselineCacheReadTokens,
          'optimized-cache-read-tokens': event.optimizedCacheReadTokens,
          'baseline-cache-write-tokens': event.baselineCacheWriteTokens,
          'optimized-cache-write-tokens': event.optimizedCacheWriteTokens,
          'baseline-reasoning-tokens': event.baselineReasoningTokens,
          'optimized-reasoning-tokens': event.optimizedReasoningTokens,
          'maturity-at': event.maturityAt,
          'maturity-status': event.maturityStatus,
          'evidence-cutoff': event.evidenceCutoff,
          'evidence-links': event.evidenceLinks,
