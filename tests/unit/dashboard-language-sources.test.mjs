...
test("published transaction sources preserve materialized token comparisons", () => {
  const rows = transactionLogRows({
    generatedAt: "2026-10-02T00:03:00Z",
    securityRuns: [{
      repository: "githubnext/gh-aw-cao",
      workflowPath: ".github/workflows/optimization-token-efficiency-verifier.lock.yml",
      runId: 307,
      runAttempt: 1,
      ...
      logsPayload: { status: "completed" },
      timeline: [{
        sourceId: "event-token-comparison",
  ...
  assert.deepEqual(rows.events[0], {
    organization: "githubnext",
    repository: "gh-aw-cao",
    workflow: ".github/workflows/optimization-token-efficiency-verifier.md",
    run: "307",
    "run-attempt": 1,
    session: rows.sessions[0].session,
    event: "event:gh-aw-logs:event-token-comparison",
    "event-timestamp": "2026-10-02T00:02:00Z",
    "event-source": "token-efficiency-verifier",
    "event-type": "token_efficiency.comparison",
    "target-repo": "octo/example",
    "target-organization": "octo",
    "target-repository": "example",
    "target-workflow-path": ".github/workflows/review.md",
    ...
    "evaluator-digest": "quality:sha256",
    "baseline-aic-per-accepted-outcome": 10,
    "optimized-aic-per-accepted-outcome": 5,
    "outcome-quality-preserved": true,
    "gross-realized-savings-aic": 10,
    "optimization-overhead-aic": 3,
    "net-realized-savings-aic": 7,
    "verified-net-gain": 0.35,
    "maturity-at": "2026-09-30T00:00:00Z",
    "maturity-status": "mature",
    "evidence-cutoff": "2026-10-01T00:00:00Z",
