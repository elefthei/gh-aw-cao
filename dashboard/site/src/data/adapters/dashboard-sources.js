  ...
  for (const candidate of events.rows) {
    ...
    observations.push({
      ...
      data: {
        ...
        verificationComparisonId: row['verification-comparison-id'],
        ...
        evaluatorDigest: row['evaluator-digest'],
        verifierRunAttempt: row['verifier-run-attempt'],
        verifierWorkflowPath: row['verifier-workflow-path'],
        verifierWorkflowName: row['verifier-workflow-name'],
        baselineWindow: row['baseline-window'],
        optimizedWindow: row['optimized-window'],
        sourceGenerations: row['source-generations'],
        baselineAicPerAcceptedOutcome: row['baseline-aic-per-accepted-outcome'],
        optimizedAicPerAcceptedOutcome: row['optimized-aic-per-accepted-outcome'],
        baselineAcceptedTargetOutcomeCount: row['baseline-accepted-target-outcome-count'],
        optimizedAcceptedTargetOutcomeCount: row['optimized-accepted-target-outcome-count'],
        acceptedTargetOutcomeCount: row['accepted-target-outcome-count'],
        baselineFailureRate: row['baseline-failure-rate'],
        optimizedFailureRate: row['optimized-failure-rate'],
        outcomeQualityPreserved: row['outcome-quality-preserved'],
        reliabilityPreserved: row['reliability-preserved'],
        grossRealizedSavingsAic: row['gross-realized-savings-aic'],
        optimizationOverheadAic: row['optimization-overhead-aic'],
        netRealizedSavingsAic: row['net-realized-savings-aic'],
        verifiedNetGain: row['verified-net-gain'],
        attributableOverheadRunIds: row['attributable-overhead-run-ids'],
        baselineInputTokens: row['baseline-input-tokens'],
        optimizedInputTokens: row['optimized-input-tokens'],
        baselineOutputTokens: row['baseline-output-tokens'],
        optimizedOutputTokens: row['optimized-output-tokens'],
        baselineCacheReadTokens: row['baseline-cache-read-tokens'],
        optimizedCacheReadTokens: row['optimized-cache-read-tokens'],
        baselineCacheWriteTokens: row['baseline-cache-write-tokens'],
        optimizedCacheWriteTokens: row['optimized-cache-write-tokens'],
        baselineReasoningTokens: row['baseline-reasoning-tokens'],
        optimizedReasoningTokens: row['optimized-reasoning-tokens'],
        maturityAt: row['maturity-at'],
        maturityStatus: row['maturity-status'],
        evidenceCutoff: row['evidence-cutoff'],
        evidenceLinks: row['evidence-links'],
