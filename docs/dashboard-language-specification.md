...
| `token-efficiency-comparisons` | one matured comparison for one intervention and evidence cutoff | scope IDs, `opportunity-id`, `intervention-id`, `comparison-id`, `implementation-change-id`, `experiment`, `evaluator-digest`, `evidence-state`, `missing-reason`, `cost-grain`, variants and frozen windows, source generations, `baseline-aic-per-accepted-outcome`, `optimized-aic-per-accepted-outcome`, baseline and optimized accepted-target-outcome counts, `accepted-target-outcome-count`, `baseline-failure-rate`, `optimized-failure-rate`, `outcome-quality-preserved`, `reliability-preserved`, separate baseline and optimized raw token classes, `gross-realized-savings-aic`, `optimization-overhead-aic`, `net-realized-savings-aic`, `verified-net-gain`, `maturity-at`, `maturity-status`, `evidence-cutoff`, `observed-at`, `evidence-link`, `repository-link`, `workflow-link`, `run-link` |
