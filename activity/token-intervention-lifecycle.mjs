...
export async function buildLifecycleObservation({
  ...
  const observation = {
    ...
    evidenceWindowStart: proposal.evidenceWindowStart,
    evidenceWindowEnd: proposal.evidenceWindowEnd,
    assignmentRunId: proposal.assignmentRunId,
    costGrain: proposal.costGrain,
    evidenceProvenance: proposal.evidenceProvenance,
    attributableRunIds: proposal.attributableRunIds,
    controlVariant: proposal.controlVariant,
    optimizedVariant: proposal.optimizedVariant,
    verificationContract: proposal.verificationContract,
